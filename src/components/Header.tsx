      ...
      <nav className="p-2 items-center w-full flex justify-between">
        <div className="text-black h-12 w-full gap-0 sm:gap-3 flex items-center justify-between">
          <div className="flex align-center">
            ...
            <div className="flex space-x-2 ml-1.5 mt-1.5 text-black	 mb-1 font-bold italic text-3xl py-1 px-1 xs:px-3 sm:px-1"><a href="/"><h1>Maritime</h1></a></div>
            <div className="flex text-black space-x-2 cursor-default mt-3 mb-1 font-semibold italic text-xl py-1 sm:px-1"><h1>Emergency</h1></div>
          </div>
